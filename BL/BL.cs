...
namespace BL
{
    ...
    public partial class BL : IBL.IBL
    {
        ...
        public BL()
        {
            ...
            {
                parcelIndex = ((List<IDAL.DO.Parcel>)MyDal.ParcelList(x=>true)).FindIndex(x => x.DroneId == drone.Id && x.Delivered == null);
                double minimumBatteryNeeded = 0;

                if (parcelIndex != -1)
                {
                    myParcel = ((List<IDAL.DO.Parcel>)(MyDal.ParcelList(x=>true)))[parcelIndex];
                    ...
                    if (myParcel.PickedUp != null)
                    {
                        ...
                        IDAL.DO.Station closestStation = GetClosestStation(targetLocation, (List<IDAL.DO.Station>)MyDal.StationList(x=>true));
                    ...
                    {
                        IDAL.DO.Station closestStation = GetClosestStation(senderLocation, (List<IDAL.DO.Station>)MyDal.StationList(x=>true));
                        droneLocation = new Location(closestStation.Longitude, closestStation.Lattitude);
                        closestStation = GetClosestStation(targetLocation, (List<IDAL.DO.Station>)MyDal.StationList(x => true));
                ...
                else
                {
                    ...
                    {
                        var parcelList = ((List<IDAL.DO.Parcel>)MyDal.ParcelList(x => true));
                        ...
                        else
                        {
                            ...
                            var closestStation = GetClosestStation(customerLocation, (List<IDAL.DO.Station>)MyDal.StationList(x => true));
                    ...
                    {
                        List<IDAL.DO.Station> stationList = (List<IDAL.DO.Station>)(MyDal.StationList(x => true));
                        Drones.Add(new DroneForList(drone.Id, drone.Model, (WeightCategories)drone.MaxWeight,
